...
import { getSanPhamOrderByCommentByStoreID } from "../../../utils/API/ProductAPI";
  ...
  return (
    <div className="page ">
      <div className="pageHead">
        ...
        <Breadcrumb
          paths={["Quản lý cửa hàng", "Đang hoạt động", "Chi tiết cửa hàng"]}
        />
      </div>
      <div className="containerProduct">
        {isLoading ? (
          ...
          <>
            ...
            <ListProductByCommentAdmin listBooks={listProduct} form={form} />
          </>
        )}
      </div>
    </div>
...
export default ManagerStoreDetails;
