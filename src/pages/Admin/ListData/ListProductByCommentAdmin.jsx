...
const ListProductByCommentAdmin = ({ listBooks = [], keySearch, searchName }) => {
    ...
    const tableRows = currentProducts.map((book, index) => (
        ...
        >
            <tr key={index} onClick={() => handleRowClick(book.ma_san_pham)}>
                ...
                <td style={{ width: '120px', textAlign: 'center' }}>{book.doanh_thu}</td>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ width: '120px', textAlign: 'center' }}>Lượt đánh giá</th>
...
export default ListProductByCommentAdmin;