...
const ListMoneyAdmin = ({ storeList = [], keySearch, searchName, trangThaiTK }) => {
    ...
    const tableRows = currentProducts.map((store, index) => (
        ...
        >
            ...
            >
                ...
                <td style={{ width: '130px', textAlign: 'center' }}>{store.diem_cua_hang ? (Math.round(store.diem_cua_hang * 10) / 10) : '0'} / 5</td>
                <td style={{ width: '100px', textAlign: 'center' }}>{store ? store.phi_dich_vu_cua_hang.toLocaleString('vi-VN') : 0}</td>
                                ...
                                <table>
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style={{ width: '150px', textAlign: 'center' }}>Phí dịch vụ</th>
