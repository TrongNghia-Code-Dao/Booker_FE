...
const ListStoreSeller = ({ storeList = [], keySearch, searchName, trangThaiTK, keyForm }) => {
        ...
        return (
            trangThaiTK === 13 ? (
                ...
                <tr key={index} className={`box-shadow_row`}
                    ...
                    <td style={{ width: '210px', fontWeight: '600' }}>{store.ten_cua_hang}</td>
                    <td style={{ width: '160px', textAlign: 'center', padding: '0 20px' }}>{store.email}</td>
                    <td style={{ width: '120px', textAlign: 'center' }}>{store.so_dien_thoai}</td>
                    <td style={{ width: '280px', textAlign: 'center', padding: '0 10px' }}>{store.dia_chi_cua_hang}</td>
...

                                        {
                                            trangThaiTK === 11 ? (
                                                <tr>
                                                    ...
                                                    <th style={{ width: '160px', textAlign: 'center' }}>Email</th>
                                                    <th style={{ width: '120px', textAlign: 'center' }}>Số điện thoại</th>
                                                    <th style={{ width: '280px', textAlign: 'center' }}>Địa chỉ</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style={{ width: '120px', textAlign: 'center' }}>Hình ảnh</th>
                                                    <th style={{ width: '210px' }}>Tên cửa hàng</th>
                                                    <th style={{ width: '190px', textAlign: 'center' }}>Email</th>
                                                    <th style={{ width: '150px', textAlign: 'center' }}>Số điện thoại</th>
                                                    <th style={{ width: '130px', textAlign: 'center' }}>Lượt bán</th>
                                                    <th style={{ width: '130px', textAlign: 'center' }}>Điểm cửa hàng</th>
                                                    {/* <th style={{ width: '100px', textAlign: 'center' }}>Còn hàng</th> */}
                                                    <th style={{ width: '100px', textAlign: 'center' }}>Trạng thái</th>
                                                    <th style={{ width: '80px', textAlign: 'center' }}></th>
