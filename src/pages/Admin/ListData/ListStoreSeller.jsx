...
const ListStoreSeller = ({
  ...
  const handleRowClick = (storeID) => {
    navigate("/admin/manager-store-details", {
    ...
    return trangThaiTK === 13 ? (
      <OverlayTrigger
        ...
        overlay={(props) =>
          renderTooltip(
            props,
            "Bấm vào để xem chi tiết cửa hàng",
            "custom-tooltip"
          )
        }
      >
        <tr
          key={index}
          onClick={() => handleRowClick(store.ma_cua_hang)}
        ...
        >
          ...
          <td style={{ width: "210px", fontWeight: "600" }}>
            {store.ten_cua_hang}
          </td>
          <td
            style={{ width: "190px", textAlign: "center", padding: "0 20px" }}
          >
            {store.email}
          </td>
          ...
          <td style={{ width: "130px", textAlign: "center" }}>
            {store.tong_luot_ban
              ? store.tong_luot_ban.toLocaleString("vi-VN")
              : 0}
          </td>
          <td style={{ width: "130px", textAlign: "center" }}>
            {store.diem_cua_hang
              ? Math.round(store.diem_trung_binh * 10) / 10
              : "0 / 5"}
          </td>
          {/* <td style={{ width: '100px', textAlign: 'center' }}>{store.so_luong_hang - store.da_ban}</td> */}
          <td
            style={{ width: "100px", textAlign: "center", fontWeight: "500" }}
            className={handleGetTrangThai(
              store.trang_thai_cua_hang?.ma_trang_thai_cua_hang
            )}
          >
          ...
          <td style={{ width: "80px", textAlign: "center" }}>
            <button
              ...
              onClick={(e) => {
                e.stopPropagation();
                handleShowDetails(store.ma_cua_hang);
              }}
            >
      ...
      <tr
        key={index}
        className={`box-shadow_row`}
        onClick={() => handleShowDetails(store.ma_cua_hang)}
      >
        <td style={{ width: "40px", textAlign: "center" }}>
          <span>{index + 1 + indexOfFirstItem}</span>
        </td>
        ...
        <td style={{ width: "280px", textAlign: "center", padding: "0 10px" }}>
          {store.dia_chi_cua_hang}
        </td>
              ...
              <thead>
                {trangThaiTK === 11 ? (
                  <tr>
                    ...
                    <th style={{ width: "280px", textAlign: "center" }}>
                      Địa chỉ
                    </th>
                    {/* <th style={{ width: '130px', textAlign: 'center' }}>Điểm cửa hàng</th> */}
...
export default ListStoreSeller;
