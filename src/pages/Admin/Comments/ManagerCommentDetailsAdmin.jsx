...
import { getBookByMaSP, getSanPhamById } from "../../../utils/API/ProductAPI";
import Loading from "../../../utils/Order/Loading";
import ListCommentDetailsAdmin from "../ListData/ListCommentDetailsAdmin";
import Breadcrumb from "../../../utils/Order/Breadcrumb";

const ManagerCommentDetailsAdmin = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        const productData = await getBookByMaSP(bookID);
  ...
  return (
    <div className="page">
      ...
      <div className="containerProduct mt__30">
        {isLoading === true ? (
          <Loading />
        ) : (
          <>
...
export default ManagerCommentDetailsAdmin;
