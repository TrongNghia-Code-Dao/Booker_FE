        ...
        <div className={fixed === true ? styles.header_fixed : styles.header_no_fixed}>
                                    ...
                                    >
                                        ...
                                        {isDropdownOpen && (
                                            <div className={styles.dropdownMenu}>
                                                <Link to="/profile-user"><span>Quản lý tài khoản</span></Link>
                                                <span onClick={toggleRechargeForm}>Nạp tiền</span> {/* Nút Nạp Tiền */}
                                                <Link to="/shopping"><span>Giỏ hàng</span></Link>
                                                {user.vai_tro.ma_vai_tro === 2 ? (
                                                    <Link to="/seller"><span>Cửa hàng của tôi</span></Link>
                                                ) : (
                                                    <Link to="/sellerRegister"><span>Đăng ký trở thành người bán</span></Link>
                                                )}
            ...
            <header className={styles.header}>
                <div className={styles.mainHeader}>
                    ...
                    >
                        <FontAwesomeIcon style={{ fontSize: '26px', color: '#ed8a47' }} icon={faShoppingCart} />
                                    ...
                                    cartItems.map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className={styles.cartItemInfo}>
                                                <h4 className={styles.cartItemName}>{item.ten_san_pham}phan trọng nghĩa đẹp trai số 1</h4>
                                                <p>x {item.so_luong}</p>
