            ...
            <div className="container">

                {
                    isLoading === true ? <Loading />
                        : (
                            <>
                                <div className="productbtn-list" style={{display: 'flex', justifyContent: 'space-between'}}>
                                    <div>
                                    ...
                                    <div>
                                        <button onClick={handleListOrderStore} className="productbtn-item btn3">
                                            <p>Cửa hàng hủy đơn</p>
                                            <h1>{orderDetailsCountStore}</h1>
                                        </button>
                                        <button className="productbtn-item btn2 no-hover productbtn-item_update">
                                            <p>Doanh thu ước tính</p>
                                            <h1>{totalRevenueStore ? totalRevenueStore.toLocaleString('vi-VN') : 0}<span> VNĐ</span></h1>
                                        </button>
                                    </div>
                                </div>
                                {/* 3 thanh tìm kiếm */}
                                ...
                                <ListOrder listOrders={listOrder} keySearch={keySearch} status='huydon' statusHeader={'Đã hủy'} title={'Khách hàng hủy đơn'} keyForm={'seller'}/>
                            </>
                        )
                }
