  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const orderData = await getDonHangById(
          orderDetailData.don_hang?.ma_don_hang
        );
          ...
          <div className="order-form_body">
            ...
            <div className="order-form_bodyInfo">
              ...
              <div className="order-form_bodyInfo-buyer-message">
                ...
                <div className="order-form_bodyInfo-buyer-messageInfo">
                  <p>
                    {donHang.loi_nhan ? donHang.loi_nhan : "Không có ghi chú."}
                  </p>
                </div>
              </div>
            ...
            <div className="order-form_bodyMoney">
              ...
              <div className="order-form_bodyMoney-main">
                ...
                <div className="order-form_bodyMoney-main_info">
                  <p>
                    Mã giảm giá <p>{orderDetail.voucher ? orderDetail.voucher?.ten_voucher : 'Chưa áp dụng'}</p>
                  </p>
                ...
                {status === "xacnhan" && (
                  <>
                    <div className="order-form_button-item">
                      <button className="buttonDefault" onClick={handleShowCancelOrder}>Hủy đơn</button>

                      <button className="buttonDefault" onClick={handleShowPrintBill}>In hóa đơn</button>

                      <button className="buttonDefault" onClick={onClose}>Đóng</button>
                    </div>

                    <button className="buttonMain" onClick={handleShowApplyOrder}>
                      Xác nhận đặt hàng
                    </button>
                  </>
                )}
