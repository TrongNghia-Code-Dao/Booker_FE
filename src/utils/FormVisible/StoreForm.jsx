                ...
                <div className=' store-form'>
                    ...
                    <div className='store-form-img'>
                        ...
                        <div className='store-form-img_changce-avt'>
                            ...
                            />
                            <label className='fontFamily' htmlFor="anh_dai_dien" style={{ margin: '0', cursor: 'pointer' }}>Thay đổi ảnh</label>
                        </div>
                        ...
                        <input
                            ...
                            style={{ cursor: 'pointer', display: 'none' }} // Đổi con trỏ thành kiểu click
                        />
                        <label className='store-form-updateAnhBia' htmlFor="anh_bia" style={{ margin: '0', cursor: 'pointer' }}>
                            <OverlayTrigger
                                placement="right"
