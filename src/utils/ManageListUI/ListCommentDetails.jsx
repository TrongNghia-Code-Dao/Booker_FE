...
import { faEllipsisVertical, faDeleteLeft, faXmark } from "@fortawesome/free-solid-svg-icons";
                        ...
                        <div className='comment' key={index}>
                            <div className='comment-flex'>
                                ...
                                <div className='comment-report'>
                                    ...
                                    <button onClick={() => handleShowReportForm(comment.ma_danh_gia, comment.tai_khoan_danh_gia, comment.don_hang_chi_tiet?.san_pham?.cua_hang)} className='comment-report_btn'>Báo cáo</button>
                                </div>
                            </div>
                            ...
                            <div onClick={() => handleShowFeedbackInput(comment.ma_danh_gia)} className='comment comment-cursor_default' key={index}>
                                ...
                                {!feedback && showFeedbackInput === comment.ma_danh_gia && (
                                    <div className='reply'>
                                        ...
                                        />
                                        <button onClick={() => handleInsertPhanHoiDanhGia(commentID, formatDateTime(new Date()), contentPhanHoi)}>Gửi</button>
                                    </div>
                                )}
